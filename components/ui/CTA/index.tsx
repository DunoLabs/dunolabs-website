...
const CTA: React.FC = () => {
  return (
    <div className="relative py-24 bg-zinc-900 sm:py-32">
      <ViewContainer>
        <CustomCursor
          image="/media/flower-cursor-img.png"
          imageHeight="200px"
          imageWidth="200px"
        >
          <HeadingBanner
            ...
            <div className="max-w-3xl mt-10">
              <p className="mt-10">
                <span className="text-lg sm:text-xl text-gray">
                  ...
                  real-world problems. We understand that you know your
                  customers and industry best, and that's why we believe in
              ...
              <p className="mt-10">
                <span className="text-lg sm:text-xl text-gray">
                  ...
                  take your digital product to the next level, drop us a line
