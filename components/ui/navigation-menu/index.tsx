...
const navigationMenuTriggerStyle = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none  disabled:opacity-50 dark:focus:bg-zinc-800 disabled:pointer-events-none  dark:data-[state=open]:bg-zinc-800 data-[active]:bg-zinc-50 dark:data-[active]:bg-zinc-800 h-10 py-2 px-4 w-max mx-2 hover:underline underline-offset-4"
);
